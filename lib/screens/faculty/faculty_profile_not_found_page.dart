...
class FacultyProfileNotFoundPage extends StatelessWidget {
  final VoidCallback? onLogout;

  const FacultyProfileNotFoundPage({super.key, this.onLogout});
                ...
                children: [
                  ...
                  const smcText(
                    textToDisplay:
                        ...
                        'Please contact your department admin to add your faculty profile with the correct mobile number.',
                    textSize: 14,
